#' Transmural Trauma Care Model (TTCM) dataset
#'
#' A dataset of 140 patients suffering from traumatic injuries, originally collected and analysed by
#' Wiertsema et al. (2019). The dataset compares two treatment options: usual care (\code{trt = 0}) and the
#' novel Transmural Trauma Care Model (TTCM, \code{trt = 1}). The treatment assignment was not randomised.
#'
#' This dataset is provided as part of the \pkg{subart2} package to illustrate methods for
#' cost-effectiveness analysis. \strong{If you use this dataset in publications or presentations, please cite
...
#' administered once at nine months post-treatment.
#'
...
#' the rehabilitation of trauma patients. \emph{European Journal of Trauma and Emergency Surgery},
#' 45(5), 783-792.
#'
...
#'
#' @source \doi{10.1007/s00068-018-0994-4}
#'
#' @examples
#' \dontrun{
#' data(ttcm)
